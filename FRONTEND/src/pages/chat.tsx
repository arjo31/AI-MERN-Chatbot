...
const chat = () => {
  ...
  const handleDeleteChats = async () => {
    try {
      ...
      console.log(e);
      toast.error("Chats could not be deleted", { id: "deletechats" });
    }
  };
  ...
  useLayoutEffect(() => {
    if (auth?.isLoggedIn && auth.user) {
      ...
      getUserChats()
        ...
        .catch((err) => {
          console.log(err);
          toast.error("Chats failed to load", { id: "loadchats" });
        });
    }
  }, [auth]);
      ...
      >
        ...
        >
          ...
          <Typography sx={{ mx: "auto", fontFamily: "work sans", my: 4, p: 3 }}>
            You can ask some questions related to any subject under the hat, but
